...
data class Deposit(
    ...
    /**
     * При начислении процентов на вклад
     * в банк принято рассчитывать сложн
     * ый процент. Смотри "капитализация вклада"
     * . Капитализация происходит каждый день. Став
     * ка в процентах, дроби процентов не допускаются.
     * При начислении процентов на вклад в банк приня
     * то рассчитывать сложный процент.
     * Смотри "капитализация вклада". Капитализация происходит каждый день.
     * Ставка в процентах, дроби процентов не допускаются.
     */
    val complexPercent: Double,
    /**
     * Для премиальных клиентов банка
     * на вклад в конце каждого месяца
     * помимо процентов начисляется вознаграждение 1% от суммы вклада.
     * Для премиальных клиентов банка н
     * а вклад в конце каждого месяца помимо процентов
