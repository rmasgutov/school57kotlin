...
class ProductTest {
    ...
    fun plusTest() {
        // given
        val product1 = Product(name = "Телевизор", price = 10000, count = 10)
        val product2 = Product(name = "Телевизор", price = 10000, count = 10)
        ...
        assertEquals(10000, actual.price)
    ...
    fun plusErrorTest() {
        // given
        val product1 = Product(name = "Телевизор", price = 10000, count = 10)
        val product2 = Product(name = "Смартфон", price = 10000, count = 10)
    ...
    fun equalsAndHashCodeTest() {
        // given
        val product1 = Product(name = "Телевизор", price = 10000, count = 10)
        val product2 = product1.copy(price = 500)
